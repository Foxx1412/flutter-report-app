...
class _RevenuePageState extends State<RevenuePage> {
  ...
  Widget _buildRevenueItem(MainModel item ) {
    ...
    String formattedValue = formatter.format(item.value);

    return GestureDetector(
      onTap: () {
        // You can add the _showDoctorRevenueChart function here if needed
        // _showDoctorRevenueChart(context, item.title);
      },
      child: Container(
